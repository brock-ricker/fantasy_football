...
v1.0: first version
v1.1: added score predictions to spreads table
v1.2: fixed team names on spreads using name dictionairy, added year to points allowed, and year/week to projected scores
v1.3: added pre-filled entries in entry widget to make it more user friendly
...
class GetEntry():
    ...
    def __init__(self, master):
        ...
        self.agent_entry.insert(0,"rickerb1")
        self.league_id_entry = tk.Entry(master)
        self.league_id_entry.insert(0,"20896")
        self.db_name_entry = tk.Entry(master)
        self.years_entry = tk.Entry(master)
        self.years_entry.insert(0,"2017,2018,2019,2020,2021")
